...
import acme.hello.config.audit.AuditEventConverter;
import acme.hello.domain.PersistentAuditEvent;
...
import static acme.hello.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
