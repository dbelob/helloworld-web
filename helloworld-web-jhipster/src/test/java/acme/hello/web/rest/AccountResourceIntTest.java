...
import acme.hello.HelloWorldApp;
import acme.hello.config.Constants;
import acme.hello.domain.Authority;
import acme.hello.domain.PersistentToken;
import acme.hello.domain.User;
import acme.hello.repository.AuthorityRepository;
import acme.hello.repository.PersistentTokenRepository;
import acme.hello.repository.UserRepository;
import acme.hello.security.AuthoritiesConstants;
import acme.hello.service.MailService;
import acme.hello.service.UserService;
import acme.hello.service.dto.PasswordChangeDTO;
import acme.hello.service.dto.UserDTO;
import acme.hello.web.rest.errors.ExceptionTranslator;
import acme.hello.web.rest.vm.KeyAndPasswordVM;
import acme.hello.web.rest.vm.ManagedUserVM;
